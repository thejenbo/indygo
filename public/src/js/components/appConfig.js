...
var resQ = angular.module('resQ', ['ngAnimate', 'ngSanitize', 'ui.router', 'ngStorage'])
	...
	.config(function($stateProvider, $locationProvider, $urlRouterProvider){
		...
		.state('home', {
			url: '/',
			views: {
				'content' : { templateUrl: 'public/src/templates/home/home.html' }
			}
		})
		.state('search', {
			url: '/search',
			views: {
				'content' : { 
					templateUrl: 'public/src/templates/search/search.html' ,
		...
		.state('results', {
			...
			views: {
				'content' : { 
					templateUrl: 'public/src/templates/results/results.html'
				},
				'results-content' : { 
					templateUrl: 'public/src/templates/results/loading/loading.html'
				}
			}
		})
		...
		.state('results.list', {
			...
			views: {
				...
				'results-content' : { 
					templateUrl: 'public/src/templates/results/list/list.html',
		...
		.state('results.dog', {
			...
			views: {
				...
				'results-content' : { 
					templateUrl: 'public/src/templates/results/dog/dog.html',
					controller: 'DogCtrl'
				}
			},
			resolve: {
		...
		.state('error', {
			url: '/error',
			views: {
				'content' : { templateUrl: 'public/src/templates/error/error.html' }
			}
		})
